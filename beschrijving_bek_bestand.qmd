...
# in geval van ontbreken worden ze geinstalleerd
RequiredPackages <- c("tidyverse","gt", "janitor", "devtools")
for (i in RequiredPackages) { #Installs packages if not yet installed
    if (!require(i, character.only = TRUE)) install.packages(i)
}

if(!require("wisselstroom", character.only = TRUE)) devtools::install_github("ed2c/wisselstroom", dependencies = TRUE, build_vignettes = TRUE)
